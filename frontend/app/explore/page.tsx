        ...
        <div className="text-center max-w-md mx-auto px-4">
          <div className="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded-lg mb-6">
            <div className="flex items-center justify-center mb-2">
              ...
              <h3 className="text-lg font-semibold">Error Loading Investments</h3>
            </div>
            ...
            <article key={investment.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1" role="article" aria-labelledby={`investment-${investment.id}-title`}>
              <div className="p-4 md:p-6">
                <div className="flex items-center justify-between mb-3 md:mb-4">
                  ...
                  <span className={`px-2 md:px-3 py-1 rounded-full text-xs font-medium ${getReputationColor(investment.borrower.reputationScore)}`} aria-label={`Borrower reputation score: ${investment.borrower.reputationScore} out of 100`}>
                    {investment.borrower.reputationScore}/100
                  </span>
                </div>

                <h3 id={`investment-${investment.id}-title`} className="text-base md:text-lg font-semibold text-gray-900 mb-2 line-clamp-1">
                  {investment.purpose}
                </h3>

                <p className="text-gray-600 mb-3 md:mb-4 line-clamp-2 text-sm leading-relaxed" aria-describedby={`investment-${investment.id}-title`}>
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    disabled={loading}
                    aria-describedby={`investment-${investment.id}-title`}
                  >
